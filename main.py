...
<dt>&lt;dl&gt;</dt>
    ...
    <p>есть выделение цитаты с помощью <q>&lt;q&gt;</q></p>
...
<article>
    <div>
        <p>ожно подключить ссылку с помощью &lt;a&gt;</p>
...
<article>
    <div>Посленее, что мы будем проходить - <a href="static/teamplates/img.html"><ins></ins>ИЗОБРАЖЕНИЯ</a></div>
